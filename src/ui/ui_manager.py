...
class UIManager:
    def __init__(self, game_controller):
        ...
        self.buttons = {
            ...
            'options_graphics': [], 'paused': []
        }
        self.pause_background = None
        self.prompt_surface, self.prompt_bg_surface, self.prompt_rects = self.create_interaction_prompt()
    ...
    def create_interaction_prompt(self):
        prompt_text = "Pressione E para interagir"
